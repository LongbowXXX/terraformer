---
description: Create a new skill (custom prompt) in .github/templates/skills/
---
...
2.  **Create Skill File**:
    ...
    - [ ] Create a new file in `.github/templates/skills/` with the format `[skill-name].prompt.template.md`.
    - [ ] The content MUST be a valid VS Code Custom Prompt file with YAML frontmatter.
    - [ ] Use `.github/templates/skills/create-custom-prompt.prompt.template.md` as a reference for structure, but adapt the content to the specific goal of the new skill.
...
3.  **Verification**:
    ...
    - [ ] Verify the file is in the correct directory: `.github/templates/skills/`.
