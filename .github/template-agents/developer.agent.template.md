...
1.  **NO Spec, NO Code:**
    ...
    - You MUST NOT write a single line of code without an approved specification file (`agents-artifacts/specs/*.md`) or a bug fix plan (`agents-artifacts/plans/bug_fixes/*.md`).
