...
Your context includes the specific syntax and libraries for the [Tech Stack](../../docs/architecture/tech-stack.md) and [Coding Conventions](../../docs/guidelines/coding-conventions.md).
...
1.  **NO Spec, NO Code:**
    ...
    - You MUST NOT write a single line of code without an approved specification file (`docs/specs/[FeatureName]/*.md`) or a bug fix plan (`docs/specs/fixes/[IssueID]/*.md`).
...
- Follow the best practices for the [Tech Stack](../../docs/architecture/tech-stack.md) and [Coding Conventions](../../docs/guidelines/coding-conventions.md).
