...
1. **The Meta-Engine (/terraform-context):**
   - **Implementation:** A dynamic **Prompt File** located at `.github/prompts/terraform-context.prompt.md`.
   - **Trigger:** User simply types `/terraform-context` in Copilot Chat.
   - **Dynamic Intelligence:**
     1. **Analyze Context:** It analyzes the current workspace (README, defined files) to understand the project structure and tech stack.
     2. **Generate AGENTS.md:** It generates the Context Map (`AGENTS.md`) as the project's constitution.
     3. **Translate AI Team:** It identifies standard agents and commands, and **translates** them if a target language is specified.
