...
1.  **Procedural Drift (New):** Agents may understand *what* to do but often forget *how* to do it correctly (e.g., skipping step-by-step reasoning or ignoring output formats).
...
3.  **Dynamic Injection:** When generating Agent definitions (`.agent.md`), the engine injects instructions such as *"When performing this task, you MUST follow the procedure defined in `#skill-name`."*
