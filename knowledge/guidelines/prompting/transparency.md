...
2.  **Instruction Injection**:
    In the command or agent definition (`.prompt.md` or `.agent.md`), explicitly instruct the model: _"You MUST include the following tag at the top of the file..."_
...
```markdown
<!-- This document is generated and updated by .github/prompts/my-command.prompt.md -->
