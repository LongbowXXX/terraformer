...
|                    | **Functional Spec**            | **Git**   | `docs/specs/*.md`          | Confirmed functional specifications. Reflects Issue discussions and must be kept up-to-date. |
|                    | **Technical Design**           | **Git**   | `docs/design/*.md`         | Confirmed system design, API definitions, DB schema, etc.                                    |
|                    | **Test Design**                | **Git**   | `docs/tests/features/*.md` | Functional test cases (procedures/expected results). Update when specs change.               |
...
|                    | **Sanity Checklist**           | **Git**   | `docs/tests/sanity.md`     | Project-wide master list of sanity test items.                                               |
