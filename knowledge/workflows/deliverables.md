...
| :------------- | :----------------------- | :-------- | :---------------------------------------- | :------------------------------------- | :------------------------------------------------------------------------------------------------ |
| 1. Requirement | Requirement Definition   | Issue     | `issues/task_requirement.md`              | -                                      | Purpose, Context, Scope, and discussion/agreement on Acceptance Criteria.                         |
...
|                | Functional Spec          | Git       | `artifacts/specification.template.md`     | `docs/specs/[Feature]/requirements.md` | Confirmed functional specifications. Reflects Issue discussions and must be kept up-to-date.      |
...
|                | Test Spec                | Git       | `artifacts/test_spec.template.md`         | `docs/specs/[Feature]/test-specs/`     | Functional test cases (procedures/expected results). Saved in `docs/specs/[Feature]/test-specs/`. |
|                | Feature Checklist        | Issue     | `issues/task_create_feature_checklist.md` | -                                      | Checklist for implementing user stories.                                                          |
