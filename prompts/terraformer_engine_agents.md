...
Your goal is to analyze a project and generate the **`.github/agents/*.agent.md`** files required to implement the **ANTP v1.3 Protocol** with GUI-based **Handoffs**.

## 🚨 PREREQUISITE: Knowledge Retrieval
**Before generating any content, you MUST uses your browsing tool to fetch and read the latest documentation from the following URL:**
...
## 📥 Input Data
(User will provide project details below)
